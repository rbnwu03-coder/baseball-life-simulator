...
verify("12. 章節評估為獨立區塊契約", script.includes('renderStatusSection("章節評估", evaluationHtml, { disclosureKey: "evaluations" })'));
verify("13. 生涯與市場為獨立區塊契約", script.includes('renderStatusSection("生涯與市場", careerHtml, { disclosureKey: "career" })'));
