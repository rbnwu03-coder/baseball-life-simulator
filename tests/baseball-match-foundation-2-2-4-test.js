...
verify("18. Case 5 兩出局仍可對實際推進本壘跑者選擇防分路線", evaluate(`__case224({runners:[null,null,"r3"],outs:2,activeRunnerBase:3,runnerMovementProgress:{2:"advancing"},routeWindows:{homeOutWindow:"normal"}}).choices.some(c=>c.routeId==="preventRunHome")`));
