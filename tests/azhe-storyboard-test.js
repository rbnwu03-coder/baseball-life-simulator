...
testAdultEcho(`player.chapter="發展期"; player.age=20; player.careerExit="大學棒球"; player.developmentStep=2; player.careerArc.stage="transition";`, "development_mentor");
