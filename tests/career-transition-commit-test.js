...
verify("20. Player Schema、Save version 與 localStorage key 完全不變", !fs.readFileSync(path.join(root, "player.js"), "utf8").includes("currentCareerRoute")
  && evaluate(runtime, "SAVE_VERSION") === 13
