...
const runtimeFiles = [
  ...
  "career-save-admission.js", "story.js", "save.js", "ai-plate-appearance-outcome.js", "defensive-runner-throw-settlement-foundation.js", "script.js"
];
const nodes = new Map();
...
verify("4. Catch success 才向下游投影 PA out", caught.state.catchResult.result === "caught" && caught.state.paCompatibilityResult.result === "out" && caught.state.paCompatibilityResult.authority === "physicalOutcomeMappingV1");
...
verify("8. Catch failure 先固定 notCaught，再交 physical official continuation", missed.state.catchResult.result === "notCaught" && missed.state.liveBallContinuation.ballRemainsLive && missed.state.paCompatibilityResult.authority === "physicalOutcomeMappingV1" && missed.state.paCompatibilityResult.resolutionMode === "compressedOfficialClassification");
