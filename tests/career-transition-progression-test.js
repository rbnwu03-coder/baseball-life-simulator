...
const protectedFiles = [
  ...
  "career-transition-runtime-resolver.js", "player.js", "style.css"
];
...
verify("39. Contract、Resolver、Commit、Runtime Resolver、Player 與 CSS 均未修改（Save 僅允許 4.10 Admission integration）", protectedDiff === "");
